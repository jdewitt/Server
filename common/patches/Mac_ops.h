...
E(OP_BuffCreate);
E(OP_BuffFadeMsg);
E(OP_BuffRemoveRequest);
E(OP_CameraEffect);
E(OP_ChangeSize);
E(OP_CharacterCreateRequest);
E(OP_ClearBlockedBuffs);
E(OP_ClearNPCMarks);
E(OP_ClearSurname);
E(OP_ClientReady);
E(OP_CloseContainer);
...
E(OP_GroupLeadershipAAUpdate);
E(OP_GroupMakeLeader);
E(OP_GroupRoles);
E(OP_GroupUpdateB);
E(OP_GroupUpdateLeaderAA);
E(OP_GuildBank);
E(OP_GuildCreate);
E(OP_GuildDemote);
E(OP_GuildManageAdd);
...
E(OP_KeyRing);
E(OP_KnowledgeBase);
E(OP_LDoNDisarmTraps);
E(OP_LDoNInspect);
E(OP_LDoNOpen);
E(OP_LDoNPickLock);
E(OP_LDoNSenseTraps);
E(OP_LeadershipExpToggle);
...
E(OP_XTargetAutoAddHaters);
E(OP_XTargetRequest);
E(OP_XTargetResponse);
E(OP_ZoneComplete);
